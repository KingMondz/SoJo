...
<body>
	...
	<div class="hero" id="fullPage">
		<div class="form-box" id="formBox">
			...
			<form id="login" class="input-group" action="tlogin.inc.php" method="post">
				...
				<br><br><br>
				<button type="submit" class="submit-btn" name="ltsubmit"><b>LogIn</b></button>

			</form>

			<form id="register" class="input-group" action="tregister.inc.php" method="post">
			  ...
			  -->
				...
				<br><br><br>
				<button type="submit" class="submit-btn" name="rtsubmit"><b>Register</b></button>
